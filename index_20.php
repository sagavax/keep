...
while ($row = mysqli_fetch_array($result)) {
	...
	echo "<div class='keep-note $color_scheme' note-id='$note_id'>";
	echo "<div class='keep-header'>$keep_title<div class='note_action'><button class='pine_note' type='button' title='delete note' onclick='remove_note($note_id)'><i class='fa fa-times'></i></button><button type='button' onclick='pine_note($note_id)' class='pine_note' title='Pin note'><i class='fa fa-thumbtack'></i></button></div></div>";
...
?>
	...
	<!--<div class="overlay" onclick="hide()">
		...
		<div class="overlay">
			<div class="note-tags">
				<div class="new-tag"><button class="pine_note" onclick="clear_input()"><i class="fa fa-times"></i></button><input type="text" id="tag_name"></div>
				<?php
...
while ($row = mysqli_fetch_array($result)) {
	...
	echo "<button class='note_pine><i class='fa fa-trash' onclick='remove_tag($tag_id)'></i> $tag_name <button class='pine_note' onclick='edit_tag($tag_id)'><i class='fa fa-pencil'></i></button>'";
}
?>
			</div>
		</div>
