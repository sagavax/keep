...
<body>
    ...
    <header>
		<div id="logo"><div class="logo"><a href="."><img src="keep.jpg"></a></div><span>axoloth's keep</span></div>
...
?>
		...
		<div class="wall-comment-container">
			<div class="keep-note-wrap">
				<input type="text" placeholder="Titulok" autocomplete="off" id="keep-title">
				<textarea name="comment"  onblur="shrink_add_note_form();" placeholder="Napisat poznamku...." maxlength="600" autocomplete="off" id="keep-text"></textarea>
...
?>
	...
	<div id="keep_tags">
		    <div class="tags_head"><button class="mb" type="button" onclick="close_tags();"><i class="fa fa-times"></i></button></div>
		    <div class="tags_search"><input type="search" id="search_tags" oninput="update_tag_name(this.value); "placeholder="Insert a tag name"><i class="fa fa-search"></i></div>
		    <div class="tags_body"></div>
			<div class="tags_foot"><span><i class="fa fa-plus"></i> Create new tag <span class="new_tag_name"></span></span></div>
	</div>
