...
<body>
    	...
    	<header><div id="logo"><a href="."><span>My keep</span></a></div><div class="search_box"><input type="text" name="search" id="search_string" autocomplete="off"></div><div id="clock"><span style="position: relative; float: left; margin-left:15px; margin-top:15px"><script language="javascript">clock()</script></span></div></div></header>
		<div id="main_wrap">
