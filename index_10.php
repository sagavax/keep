...
?>
		...
		<div id="wall-comment">
			<textarea name="comment" maxlength="600" autocomplete="off" id="keep-text" onblur="save_note()"></textarea>
		</div>
		<div id="keep-pinned">
...
while ($row = mysqli_fetch_array($result)) {
	...
	echo "<div class='keep-note' note-id='$note_id' style='background:'.$bckground.'>";
