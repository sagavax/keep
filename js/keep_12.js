...
const palettes = document.querySelectorAll("color_palette");
...
function show_palette_1(e){
      //determine if any other paletes already exists
     ...
     const palettes = document.querySelectorAll(".color_palette") ;
      if(palettes.length>0){
            alert("Mam pootvarane okna");
            const opened_palettes = document.querySelectorAll(".color_palette");
            for(var z=0; z<opened_palettes.length; z++){
                opened_palette = opened_palettes[z];
                opened_palette.parentNode.removeChild(opened_palette);
                //console.log(opened_palette);
            }
            //zatvor otvorenu paletu
      }
    ...
    //create palette
        ...
        palette.classList.add("color_palette");
        //zistime poziciu paletty
        var offsets = palette.getBoundingClientRect();
